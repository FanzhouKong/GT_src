...
def calculate_entropy_similarity(spectrum_a: Union[list, np.ndarray], spectrum_b: Union[list, np.ndarray],
    ...
    if need_clean_spectra:
        spectrum_a = tools.clean_spectrum(spectrum_a, noise_removal=noise_removal, ms2_ppm=ms2_ppm, ms2_da=2*ms2_da)
        spectrum_b = tools.clean_spectrum(spectrum_b, noise_removal=noise_removal, ms2_ppm=ms2_ppm, ms2_da=2*ms2_da)
    else:
