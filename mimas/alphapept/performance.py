# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/12_performance.ipynb.

# %% auto 0
__all__ = ['COMPILATION_MODE_OPTIONS', 'MAX_WORKER_COUNT', 'DYNAMIC_COMPILATION_ENABLED', 'is_valid_compilation_mode',
           'set_worker_count', 'set_compilation_mode', 'compile_function', 'performance_function', 'AlphaPool']

# %% ../nbs/12_performance.ipynb 3
...
# %% ../nbs/12_performance.ipynb 7
if __GPU_AVAILABLE:
    COMPILATION_MODE = "cuda"
else:
    COMPILATION_MODE = "numba"

# %% ../nbs/12_performance.ipynb 9
